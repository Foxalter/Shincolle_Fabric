package com.techlorine.shincolle.init;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

import com.techlorine.shincolle.item.AbyssMetalItem;
import com.techlorine.shincolle.item.AbyssNuggetItem;
import com.techlorine.shincolle.item.AmmoItem;
import com.techlorine.shincolle.item.BasicItem;
import com.techlorine.shincolle.item.GrudgeItem;
